...
class PuzzleTag(models.Model):
    ...
    FREEBIE = "Freebie"
    NEW_TAG_ID = 1320198250489319434
    WORKING_TAG_ID = 1320199606243561513
    EXTRACTING_TAG_ID = 1320199821130203167
    STUCK_TAG_ID = 1320199859961200710
    SOLVED_TAG_ID = 1320199886192250990
    ABANDONED_TAG_ID = 1320565939443470407
